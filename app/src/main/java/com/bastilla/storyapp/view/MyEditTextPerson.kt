package com.bastilla.storyapp.view
...
class MyEditTextPerson : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        personImage = ContextCompat.getDrawable(context, R.drawable.ic_person_focus) as Drawable
